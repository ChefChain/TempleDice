...
<table>
   ...
   <tr>
      <td rowspan="4" style=font-weight:bold>UIKitProvider</td>
      <td rowspan="4"  style=font-size:10px>The UIKitProvider does not render any UI but only provides global context for components. It automatically listens to SDK events, transmits data downward, and drives component rendering</td>
      <td style=font-size:10px>
      initConfig: {
        appkey: string
      }
...
- [Agora Chat UIKit docs](https://github.com/AgoraIO-Usecase/AgoraChat-UIKit-web/tree/dev/docs/en)
